...
const First_Pane = () => {
  return (
    <div >
        ...
        {/*****Desktop device**************/} 
        <div className='bg-green uk-visible@s'>
            <div className=' lg:px-20 lg:pt-20'>
            <div class="flex flex-wrap">
            <div class="w-full md:w-1/2  pt-5">
                <div class="p-4">
                  <h2 class="text-4xl  md:text-9xl lg:text-7xl font-semibold   font-Poppins  text-white">Get Value for Money and Skills </h2>
                
                  <p className='text-[20px] pt-6 text-white font-GeorgiaRegular'>
                  Would you like to get value for money in engaging an artisan or offer value for money as an artisan?
                  </p>
                </div>
        ...
        {/*****Mobile device**************/}
        <div className='bg-green uk-hidden@s'>
            <div className=' lg:px-20 lg:pt-20'>
            <div class="flex flex-wrap">
            <div class="w-full md:w-1/2  pt-5">
