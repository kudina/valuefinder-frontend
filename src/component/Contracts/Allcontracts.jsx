 ...
 const Allcontracts = ()=>{
    ...
    const result = data?.data.filter(i => i.contractState == "created") 
...
const updatecontract = (i)=>{
  ...
  const payload = {...i, contractState: "active", stage:"active"}
                ...
                return(
                    ...
                    <button onClick={()=> { setOverlay(<OverlayOne />)
                     ...
                     type="submit" class="w-full bg-green hover:bg
                      ...
                      <button onClick={()=> updatecontract(i)}  type="submit" class="w-full bg-green hover:bg
                      -blueGray-700 focus:ring-blueGray-500  text-white px-2 py-3 text-[12px]
                      rounded-sm  shadow-lg cursor-pointer transition ease-in duration-200 text-center
                      ...
                      <button onClick={()=>alert("clicked")}  type="submit" class="w-full bg-green hover:bg
                      -blueGray-700 focus:ring-blueGray-500  text-white px-2 py-3 text-[12px]
                      rounded-sm  shadow-lg cursor-pointer transition ease-in duration-200 text-center 
                      hover:-translate-y-1 ">
                        Decline Request
